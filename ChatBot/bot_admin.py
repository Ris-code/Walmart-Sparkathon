...
def chat_admin():
    print(1)
    st.markdown("<h1 style='text-align: center; color: white; margin-top: -20px'>Ask Walmart Supply Bot</h1>", unsafe_allow_html=True)

    button_dic = {"pay_query": "Product Stocks", 
                "refund_return": "Last month sales", 
                "product_query": "Demanded Products",
                }
    

    with st.chat_message("assistant"):
        st.markdown(f"Hello Admin, I'm here to assist you. Please feel free to ask any questions.")
        ...
        pay_query = st.button("Product Stocks")
        refund_return = st.button("Last month sales")
        product_query = st.button("Demanded Products")
